            ...
            <section className="py-24 md:py-32 bg-[#0F172A] relative overflow-hidden text-center border-t border-slate-800">
                ...
                <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group inline-flex items-center justify-center w-full sm:w-auto gap-4 bg-emerald-500 hover:bg-emerald-600 text-white font-black text-xl px-12 py-6 rounded-2xl transition-all shadow-2xl shadow-emerald-500/25 hover:shadow-emerald-500/40 hover:-translate-y-1 active:scale-95 mb-6"
                    >
                    ...
                    <button
                        onClick={() => navigate('/')}
                        className="group inline-flex items-center justify-center w-full sm:w-auto gap-3 bg-[#1E293B] border border-slate-700 hover:border-white text-white font-bold text-lg px-8 py-4 rounded-2xl transition-colors sm:ml-4"
                    >
